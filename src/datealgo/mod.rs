...
//! 
//! This module has been included directly as source from the
//! [datealgo](https://crates.io/crates/datealgo) crate.
//! 
//! See the [datealgo documentation](https://docs.rs/datealgo) for more information.
#![forbid(unsafe_code)]
