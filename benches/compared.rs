...
mod rd_to_date {
    ...
    #[divan::bench]
    fn datealgo(b: divan::Bencher) {
        b.with_inputs(rand_rd).bench_refs(|i| datealgo::rd_to_date(divan::black_box(*i)));
    }

    #[divan::bench]
    fn hinnant_unsigned(b: divan::Bencher) {
        b.with_inputs(super::rand_rd).bench_refs(|i| hinnant::civil_from_days_u(divan::black_box(*i)));
    }

    #[divan::bench]
    fn hinnant(b: divan::Bencher) {
        b.with_inputs(super::rand_rd).bench_refs(|i| hinnant::civil_from_days(divan::black_box(*i)));
    }

    #[divan::bench]
    fn httpdate(b: divan::Bencher) {
        b.with_inputs(super::rand_rd).bench_refs(|i| httpdate::rd_to_date(divan::black_box(*i)));
    }

    #[divan::bench]
    fn humantime(b: divan::Bencher) {
        b.with_inputs(super::rand_rd).bench_refs(|i| humantime::rd_to_date(divan::black_box(*i)));
    }

    #[divan::bench]
    fn chrono(b: divan::Bencher) {
        b.with_inputs(super::rand_rd).bench_refs(|i| chrono::rd_to_date(divan::black_box(*i)));
    }

    #[divan::bench]
    fn time(b: divan::Bencher) {
        b.with_inputs(super::rand_rd).bench_refs(|i| time::rd_to_date(divan::black_box(*i)));
    }
}
...
mod date_to_rd {
    ...
    #[divan::bench]
    fn hinnant_unsigned(b: divan::Bencher) {
        b.with_inputs(rand_date).bench_refs(|i| hinnant::days_from_civil_u(divan::black_box(*i)));
    }

    #[divan::bench]
    fn hinnant(b: divan::Bencher) {
        b.with_inputs(rand_date).bench_refs(|i| hinnant::days_from_civil(divan::black_box(*i)));
    }

    #[divan::bench]
    fn httpdate(b: divan::Bencher) {
        b.with_inputs(rand_date).bench_refs(|i| httpdate::date_to_rd(divan::black_box(*i)));
    }

    #[divan::bench]
    fn humantime(b: divan::Bencher) {
        b.with_inputs(rand_date).bench_refs(|i| humantime::date_to_rd(divan::black_box(*i)));
    }

    #[divan::bench]
    fn chrono(b: divan::Bencher) {
        b.with_inputs(rand_date).bench_refs(|i| chrono::date_to_rd(divan::black_box(*i)));
    }

    #[divan::bench]
    fn time(b: divan::Bencher) {
        b.with_inputs(rand_date).bench_refs(|i| time::date_to_rd(divan::black_box(*i)));
    }
}
...
mod rd_to_weekday {
    ...
    #[divan::bench]
    fn datealgo_alt(b: divan::Bencher) {
        b.with_inputs(rand_rd).bench_refs(|i| datealgo_alt::rd_to_weekday(divan::black_box(*i)));
    }

    #[divan::bench]
    fn datealgo_alt2(b: divan::Bencher) {
        b.with_inputs(rand_rd).bench_refs(|i| datealgo_alt::rd_to_weekday2(divan::black_box(*i)));
    }
}
...
mod date_to_weekday {
    ...
    #[divan::bench]
    fn datealgo_alt(b: divan::Bencher) {
        b.with_inputs(rand_date).bench_refs(|i| datealgo_alt::date_to_weekday(divan::black_box(*i)));
    }

    #[divan::bench]
    fn datealgo_alt2(b: divan::Bencher) {
        b.with_inputs(rand_date).bench_refs(|i| datealgo_alt::date_to_weekday2(divan::black_box(*i)));
    }
}
...
mod next_date {
    ...
    #[divan::bench]
    fn datealgo_alt(b: divan::Bencher) {
        b.with_inputs(rand_date).bench_refs(|i| datealgo_alt::next_date(divan::black_box(*i)));
    }

    #[divan::bench]
    fn chrono(b: divan::Bencher) {
        b.with_inputs(chrono::rand_date).bench_refs(|i| chrono::next_date(divan::black_box(*i)));
    }

    #[divan::bench]
    fn time(b: divan::Bencher) {
        b.with_inputs(time::rand_date).bench_refs(|i| time::next_date(divan::black_box(*i)));
    }
}
...
mod prev_date {
    ...
    #[divan::bench]
    fn datealgo_alt(b: divan::Bencher) {
        b.with_inputs(rand_date).bench_refs(|i| datealgo_alt::prev_date(divan::black_box(*i)));
    }

    #[divan::bench]
    fn chrono(b: divan::Bencher) {
        b.with_inputs(chrono::rand_date).bench_refs(|i| chrono::prev_date(divan::black_box(*i)));
    }

    #[divan::bench]
    fn time(b: divan::Bencher) {
        b.with_inputs(time::rand_date).bench_refs(|i| time::prev_date(divan::black_box(*i)));
    }
}
...
mod secs_to_dhms {
    ...
    #[divan::bench]
    fn datealgo_alt(b: divan::Bencher) {
        b.with_inputs(rand_secs).bench_refs(|i| datealgo_alt::secs_to_dhms(divan::black_box(*i)));
    }

    #[divan::bench]
    fn datealgo_alt2(b: divan::Bencher) {
        b.with_inputs(rand_secs).bench_refs(|i| datealgo_alt::secs_to_dhms2(divan::black_box(*i)));
    }
}
...
mod is_leap_year {
    ...
    #[divan::bench]
    fn datealgo_alt(b: divan::Bencher) {
        b.with_inputs(rand_year).bench_refs(|i| datealgo_alt::is_leap_year(divan::black_box(*i)));
    }

    #[divan::bench]
    fn datealgo_alt2(b: divan::Bencher) {
        b.with_inputs(rand_year).bench_refs(|i| datealgo_alt::is_leap_year2(divan::black_box(*i)));
    }

    #[divan::bench]
    fn datealgo_alt3(b: divan::Bencher) {
        b.with_inputs(rand_year).bench_refs(|i| datealgo_alt::is_leap_year3(divan::black_box(*i)));
    }

    #[divan::bench]
    fn datealgo_alt4(b: divan::Bencher) {
        b.with_inputs(rand_year).bench_refs(|i| datealgo_alt::is_leap_year4(divan::black_box(*i)));
    }
}
...
mod days_in_month {
    ...
    #[divan::bench]
    fn datealgo_alt(b: divan::Bencher) {
        b.with_inputs(rand_ym).bench_refs(|i| datealgo_alt::days_in_month(divan::black_box(i.0), divan::black_box(i.1)));
    }

    #[divan::bench]
    fn datealgo_alt2(b: divan::Bencher) {
        b.with_inputs(rand_ym).bench_refs(|i| datealgo_alt::days_in_month2(divan::black_box(i.0), divan::black_box(i.1)));
    }
}

mod date_to_isoweekdate {
    use super::*;
    ...
    #[divan::bench]
    fn chrono(b: divan::Bencher) {
        b.with_inputs(rand_date).bench_refs(|i| chrono::date_to_isoweekdate(divan::black_box(*i)));
    }

    #[divan::bench]
    fn time(b: divan::Bencher) {
        b.with_inputs(rand_date).bench_refs(|i| time::date_to_isoweekdate(divan::black_box(*i)));
    }
}

mod isoweekdate_to_date {
    use super::*;
    ...
    #[divan::bench]
    fn chrono(b: divan::Bencher) {
        b.with_inputs(rand_iwd).bench_refs(|i| chrono::isoweekdate_to_date(divan::black_box(*i)));
    }

    #[divan::bench]
    fn time(b: divan::Bencher) {
        b.with_inputs(rand_iwd).bench_refs(|i| time::isoweekdate_to_date(divan::black_box(*i)));
    }
}

mod systemtime_to_secs {
    use super::*;
    ...
    #[divan::bench]
    fn datealgo_alt(b: divan::Bencher) {
        b.with_inputs(rand_st).bench_refs(|i| datealgo_alt::systemtime_to_secs(divan::black_box(*i)));
    }
}

mod secs_to_systemtime {
    use super::*;
...
mod systemtime_to_datetime {
    ...
    #[divan::bench]
    fn httpdate(b: divan::Bencher) {
        b.with_inputs(rand_st).bench_refs(|i| httpdate::systemtime_to_datetime(divan::black_box(*i)));
    }

    #[divan::bench]
    fn humantime(b: divan::Bencher) {
        b.with_inputs(rand_st).bench_refs(|i| humantime::systemtime_to_datetime(divan::black_box(*i)));
    }

    #[divan::bench]
    fn time(b: divan::Bencher) {
        b.with_inputs(rand_st).bench_refs(|i| time::systemtime_to_datetime(divan::black_box(*i)));
    }

    #[divan::bench]
    fn chrono(b: divan::Bencher) {
        b.with_inputs(rand_st).bench_refs(|i| chrono::systemtime_to_datetime(divan::black_box(*i)));
    }
}

mod datetime_to_systemtime {
    use super::*;
    ...
    #[divan::bench]
    fn httpdate(b: divan::Bencher) {
        b.with_inputs(rand_dtn).bench_refs(|i| httpdate::datetime_to_systemtime(divan::black_box(*i)));
    }

    #[divan::bench]
    fn humantime(b: divan::Bencher) {
        b.with_inputs(rand_dtn).bench_refs(|i| humantime::datetime_to_systemtime(divan::black_box(*i)));
    }

    #[divan::bench]
    fn time(b: divan::Bencher) {
        b.with_inputs(rand_dtn).bench_refs(|i| time::datetime_to_systemtime(divan::black_box(*i)));
    }

    #[divan::bench]
    fn chrono(b: divan::Bencher) {
        b.with_inputs(rand_dtn).bench_refs(|i| chrono::datetime_to_systemtime(divan::black_box(*i)));
    }
}
